                            ...
                            if b.tab==currentTab and not b.isSlider and showSet[b.bg] then
                                if inBox(uiX+b.rx,uiY+(b.currentRY or b.ry),b.cw,b.ch) then
                                    ...
                                    elseif b.isDiv and b.collapsible and b.sectionName then
                                        ...
                                        local currentY = 10 -- Start with some padding
                                        local activeSectionY = b.ry
                                        ...
                                        for _, cb2 in ipairs(btns) do
                                            if cb2.tab == currentTab then
                                                if cb2.isDiv then
                                                    ...
                                                    cb2.baseRY = ry
                                                    bShow(cb2, true)
                                                    currentY = currentY + 22 -- Increased spacing
                                                else
                                                    local isCollapsed = cb2.section and _collapseSections[cb2.section]
                                                    if isCollapsed then
                                                        cb2._collapsing = true
                                                        cb2._collapseTarget = b.ry + 14
                                                    else
                                                        local ry = L.TOPBAR + currentY
                                                        cb2.ry = ry
                                                        cb2.baseRY = ry
                                                        if cb2._collapsing then
                                                            cb2._collapsing = false
                                                            cb2._collapseTarget = nil
                                                        end
                                                        bShow(cb2, true)
                                                        currentY = currentY + (cb2.isSlider and L.ROW_H + 10 or L.ROW_H + 4) -- Increased spacing
                                                    end
                                                end
                                            end
                                        end
