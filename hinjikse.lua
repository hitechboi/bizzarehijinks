...
boosts:Slider("Ability Speed", 1, 100, 1, function(v) abilitySpeed=v end, false, "Multiplies the speed of your cooldowns")
...
misc:Slider("Run Speed", 1, 100, 1, function(v) runSpeed=v end, true, "Multiplies RunningSpeed value")
misc:Slider("Damage Multiplier", 1, 10, 1, function(v) damageMultiplierValue=v end, true, "Multiplies damage (works??)")
misc:Div("APPEARANCE")
