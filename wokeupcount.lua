        ...
        while not destroyed do
            ...
            if not minimized then
                ...
                if dScrollThumb and dScrollBg then
                    ...
                    local pt=tick(); local op
                    if menuOpen then op=clamp((pt-menuToggledAt)/FADE_DUR,0,1)
                    else op=clamp(1-(pt-menuToggledAt)/FADE_DUR,0,1) end
