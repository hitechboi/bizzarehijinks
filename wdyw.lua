        ...
        spawn(function()
            ...
            updateLoaderFrame = function()
                if dBg and dBg.Visible then
                    ...
                    local fillW = bw * (dBarFg.Size.magnitude > 0 and (dBarFg.Size.X / bw) or 0)
        ...
        while not destroyed do
            ...
            if not minimized then
                ...
                if dragging and clicking then
                    ...
                    uiX = math.floor(uiX + (tx - uiX) * 0.4)
                    uiY = math.floor(uiY + (ty - uiY) * 0.4)
                    if math.abs(tx - uiX) > 0.5 or math.abs(ty - uiY) > 0.5 then
                        updatePos()
