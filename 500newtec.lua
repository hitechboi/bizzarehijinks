...
function UILib.Window(titleA, titleB, gameName)
    ...
    local function updatePos()
        ...
        dTitleW.Position  =Vector2.new(uiX+L.SIDEBAR+8,uiY+10)
        dTitleA.Position  =Vector2.new(uiX+L.SIDEBAR+52+8,uiY+10) -- reduced gap from 64 to 52
        dTitleG.Position  =Vector2.new(uiX+L.SIDEBAR+100+8,uiY+12)
    ...
    local function updateMiniPos()
        ...
        dMiniTitleW.Position =Vector2.new(uiX+8,uiY+7)
        dMiniTitleA.Position =Vector2.new(uiX+52+8,uiY+7) -- reduced gap
        dMiniTitleG.Position =Vector2.new(uiX+100+8,uiY+9)
