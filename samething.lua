...
function UILib.Window(titleA, titleB, gameName)
    ...
    local function bPos(b)
        ...
        if b.isDiv then
            ...
            if b.arrow then setTriDir(b.arrow, ax+b.cw-6, ay+5, _collapseSections[b.sectionName] and ">" or "v") end
        elseif b.isAct then
        ...
        elseif b.isDropdown then
            ...
            setTriDir(b.arrow, ax+b.cw-12, ay+b.ch/2, b.open and "^" or "v")
        ...
        for _,b in ipairs(btns) do
            if b.tab==name then
                if b.isDiv and b.collapsible and b.sectionName then
                    ...
                    if b.arrow then setTriDir(b.arrow, uiX+b.rx+b.cw-6, uiY+b.ry+5, "v") end
                end
    ...
    local function addDiv(tab,lbl,relY,collapsible)
        ...
        local arrow
        if collapsible then
            local ax2=uiX+rx+cw-10; local ay2=uiY+ry+2
            arrow=mkD(mkTri(ax2,ay2, ax2+8,ay2, ax2+4,ay2+6, C.GRAY,true,8))
    ...
    local function addDropdown(tab,lbl,relY,options,initIdx,cb)
        ...
        local ax3=uiX+rx+cw-16; local ay3=uiY+ry+ch/2-3
        local arrow=mkD(mkTri(ax3,ay3, ax3+8,ay3, ax3+4,ay3+6, C.GRAY,true,8))
        local optBgs={}
                        ...
                        if b.tab==currentTab and not b.isSlider and showSet[b.bg] then
                            if inBox(uiX+b.rx,uiY+(b.currentRY or b.ry),b.cw,b.ch) then
                                ...
                                elseif b.isDiv and b.collapsible and b.sectionName then
                                    ...
                                    setTriDir(b.arrow, uiX+b.rx+b.cw-6, uiY+b.ry+5, _collapseSections[sec] and ">" or "v")
                ...
                if clicking and not wasClicking and openDropdown then
                    ...
                    for i,o in ipairs(bd.optBgs) do
                        ...
                        if inBox(ox,oy,bd.cw,bd.ch) then
                            ...
                            bd.open=false; setTriDir(bd.arrow, uiX+bd.rx+bd.cw-12, uiY+bd.ry+bd.ch/2, "v")
                            openDropdown=nil
